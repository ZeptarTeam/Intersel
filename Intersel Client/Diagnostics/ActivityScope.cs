...
namespace System.Diagnostics
{
    ...
    <ExtendedData xmlns='http://schemas.microsoft.com/2006/08/ServiceModel/DictionaryTraceRecord'>
        ...
        public ActivityScope()
            : this((TraceSource)null, 0, 0, 0, 0, null, null, null, null, null)
        {
        }
            ...
            string transferInMessage, string startMessage, string transferOutMessage, string stopMessage, string activityName)
        {
            ...
            _transferInMessage = transferInMessage ?? ActivityScope_Transfer;
            _startMessage = startMessage ?? ActivityScope_Start;
            _transferOutMessage = transferOutMessage ?? ActivityScope_Transfer;
            _stopMessage = stopMessage ?? ActivityScope_Stop;
